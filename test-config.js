...
const TEST_DEFINITIONS = [
  { key: "FERITINA", name: "Feritina", pattern: "Feritina" },
  {
    ...
    pattern: "Bilirubin[ăa]?\\s+total[ăa]?",
  },
  {
    key: "DBIL",
    name: "Bilirubina directă",
    pattern: "Bilirubin[ăa]?\\s+direct[ăa]?",
  },
  {
    key: "IBIL",
    name: "Bilirubina indirectă",
    pattern: "Bilirubin[ăa]?\\s+indirect[ăa]?",
  },
  ...
  { key: "25OHD", name: "25-OH Vitamina D", pattern: "25-OH\\s+Vitamina\\s+D" },
  {
    ...
    pattern: "Hemoglobina glicozilata\\s*\\(HbA1c\\)",
  },
  ...
  // Do not import Glucose as it creates conflicts with our internal measurements
  ...
  {
    key: "PTH",
    name: "Intact PTH (Parathormon)",
    pattern: "Intact\\s+PTH(\\s*\\(Parathormon\\))?",
  },
  {
    key: "ATPO",
    name: "Anti-TPO (Anti-tiroidperoxidaza)",
    pattern: "Anti[-\\s]?TPO(\\s*\\(Anti[-\\s]?tiroidperoxidaz[ăa]\\))?",
  },
  {
    key: "ACHCV",
    name: "Anticorpi anti-HCV",
    pattern: "Anticorpi\\s+anti[-\\s]?HCV",
  },
  ...
  {
    key: "hsCRP",
    name: "Proteina C Reactivă HS",
    pattern: "Protein[ăa]?\\s+C\\s+[Rr]eactiv[ăa]?\\s+HS",
  },
  {
    key: "CRP",
    name: "Proteina C reactivă (CRP)",
    pattern:
      "Protein[ăa]?\\s+C\\s+[Rr]eactiv[ăa]?,?\\s+cantitativ\\s*\\(CRP\\)",
  },
